...
Rabet_graph_config = {'displayModeBar': False, 'scrollZoom': False, 'staticPlot': False}
...
Rabet_graph_background_color = ["plotly", "plotly_white", "plotly_dark", "ggplot2", "seaborn", "simple_white", "none"]

"""Pick the background color to be used. this has to be in the range 0 - 6. Default is 5 for SIMPLE_WHITE"""
Rabet_bg_color = Rabet_graph_background_color[2]
...
Rabet_creator_url='https://www.linkedin.com/in/gaylord-odhiambo-992990150/'
